...
// PRJECT
const SELECT_PROJECTS = "SELECT PROJECT_NAME, PERIOD_FROM, PERIOD_TO, INTRODUCE, DESCRIPTION, TECHS, PERSONAL_ROLE, LINK FROM PROJECT WHERE PERSON_ID = ? ORDER BY PERIOD_TO DESC"
